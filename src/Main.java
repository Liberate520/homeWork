...
import ThreeFamily.IThree;
import ThreeFamily.Repository;
import ThreeFamily.RepositoryThree;
import ThreeFamily.TreeFamily;
...
public class Main {
    public static void main(String[] args) {
        ...
        Repository repository = new RepositoryThree();
