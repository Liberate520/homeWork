...
public class Main {
    public static void main(String[] args) {
        ...
        /*
         * Время вышло, а домашка не готова, по этому сдаю ссылку на пулл реквест без изменений и сажусь писать, в надежде на то, что к тому моменту когда вы доберетесь до неё, она уже будет готова)))
         */
    }
}
