...
/*
Закончена реализация вывода потомков
Добавлен UIInterface который будет использоваться для описания Меню. Реализован один пример
Похоже у меня случайно получился изначально не MVC а именно MVP. Задачи Презентора выполняет Контроллер.
 по этому задачу структуры 5-го семинара считаю выполненой.
 */