...
import Model.familyTree.iterator.FamilyTreeIterator;
import Model.obj.human.Human;
import Model.obj.human.sort.SortByAge;
import Model.obj.human.sort.SortByBornDate;
import Model.obj.human.sort.SortByFirstName;
import Model.obj.human.sort.SortByLastName;
...
public class FamilyTree<E extends FamilyTreeItem<E>> implements Iterable<E>,Serializable{
    ...
    public E getByFIO(String name, String family){
        for(E human : humanList){
    ...
    public void sortByFirstName(){
        humanList.sort(new SortByFirstName<E>());
    }

    public void sortByLastName(){
        humanList.sort(new SortByLastName<E>());
    }

    public void sortByAge(){
        humanList.sort(new SortByAge<E>());
    }

    public void sortByBornDate(){
        humanList.sort(new SortByBornDate<E>());
    }
