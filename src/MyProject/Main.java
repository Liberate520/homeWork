package MyProject;/*
Изменить древо, сделать класс параметизированным. Продумать класс общения с пользователем,
...
public class Main{
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            System.out.println("Поиск(1), Весь список(2), Сортировка по имени(3), Сортировка по годам(4), Сохранить(5), Востановить(6), Выход(7): ");
