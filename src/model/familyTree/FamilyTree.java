...
import model.person.comparators.PersonComparatorByAge;
import model.person.comparators.PersonComparatorByFirstName;
import model.person.comparators.PersonComparatorByLastName;
...
public class FamilyTree<E extends Anthropoid> implements Serializable, Iterable<E> {
    private TreeSet<E> personsSet;

    public FamilyTree() {
        this.personsSet = new TreeSet<>(new PersonComparatorByLastName<>());
    }
    ...
    public TreeSet<E> getTreeSortByFirstName(){
        ...
        personsSet.clear();
        personsSet.addAll(newPersonSet);
        return newPersonSet;
    }

    public TreeSet<E> getTreeSortByLastName(){
        TreeSet<E> newPersonSet = new TreeSet<>(new PersonComparatorByLastName());
        newPersonSet.addAll(personsSet);
        personsSet.clear();
        personsSet.addAll(newPersonSet);
        return newPersonSet;
    ...
    public TreeSet<E> getTreeSortByAge(){
        TreeSet<E> newPersonSet = new TreeSet<>(new PersonComparatorByAge<>());
        newPersonSet.addAll(personsSet);
        personsSet.clear();
        personsSet.addAll(newPersonSet);
        return newPersonSet;
