...
public class Human implements Serializable, FamilyTreeItem<Human>{
    ...
    public Human(int id, String name, Gender gender, LocalDate birthDate) {
        this (id, name, gender, birthDate, null, null, null, null, null);
    }

    public Human(int id, String name, Gender gender, LocalDate birthDate, Human wife) {
        this (id, name, gender, birthDate, null, null, null, wife);
    }

    public Human(int id, String name, Gender gender, LocalDate birthDate, Human father, Human mother) {
        this (id, name, gender, birthDate, null, father, mother, null, null);
    }    

    public Human(int id, String name, Gender gender, LocalDate birthDate,
    Human father, Human mother, Human wife, Human husband) {
        this (id, name, gender, birthDate, null, father, mother, wife, husband);
    }
