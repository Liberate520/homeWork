...
> Решение домашнего задания
> Удалил лишние методы оставил наиболее эффективные (тем самым сделал проект более читабельным, Код стал меньше) 
> Переделал все scannerЫ на JOptionPane (Код стал короче)
> Удалил все лишние методы и классы 
> Поработал над инкапсуляцией еще лучше 
> Переработал метод addHuman 
> 
> 
> 1. В Классе ViewNew -> Зациклил  вюшку для обработки повторений, выбор был между исключением ошибки, но тогда я бы не 
...
> Пробовал этот блок запихнуть, в интерфейс реализовать его в отдельном классе, вызвать его тут и перегрузить (Ничего
     не вышло) оставил рабочий вариант
> Добавил toLowerCase для исключения ошибки ввода по регистру.
> 2. Переделал все методы (В один стиль)
> 3. 
> 
