...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        while (!cmd.equals("q")){//////////////////////////////////////////////////////пока не введена команда выход
            switch(cmd){
                case "1"://////////////////Добавление нового человека//////////////////////
                    ...
                    switch(selParInfo){
                        case "1"://родители есть
                            ...
                            List<Person> potentialFathers = tree.findPersons(fSurname);//получение списка людей с такой же фамилией
                            System.out.println(tree.showFamily(potentialFathers));//вывод списка найденных людей
                            ...
                            List<Person> potentialMothers = tree.findPersons(mSurname);//получение списка людей с такой же фамилией
                            System.out.println(tree.showFamily(potentialMothers));//вывод списка найденных людей
                            ...
                            tree.addPerson(addedPerson,father,mother);//добавление человека в список 
                            break;
                ...
                case "2":
                    ...
                    System.out.println(tree.showFamily(tree.findPersons(searchSurname)));//вывод списка найденных людей
                    break;
                case "3":
                    System.out.println("**********Вывод списка всех людей в дереве**********");
                    // System.out.println(tree);//вывод списка всех людей
                    tree.getPersonList().sort(new ComparatByName());
                    for(Person item : tree){
                        System.out.println(item);
                    }
                    System.out.println();
                    tree.getPersonList().sort(new ComparatByYoB());
                    for(Person item : tree){
                        System.out.println(item);
                    }
                    break;
        ...
        // tree.addPerson();
        // tree.addPerson();
        // tree.addPerson(tree.getFamily().get(0), tree.getFamily().get(1));//добав человека с родителями  1 и 2 из списка
        // System.out.println(tree);
        // tree.getFamily().get(0).showChildren();//показать детей 1го родителя
        // System.out.println(tree.showFamily(tree.findPersons("Иванов")));//tree.findPersons("Иванов").showFamily();//в идеале так вызывать
        
        // System.out.println("1 метод");
        // System.out.println(tree);
        // System.out.println("2 метод");
        // System.out.println(tree.showFamily(tree.getFamily()));
        // System.out.println("3 метод");
        // List<Person> persons = tree.getFamily();
        // System.out.println(tree.showFamily(persons));
    }
}