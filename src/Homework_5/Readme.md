...
> Я хотел создать интерфейс с методами print для печати и сделать implements в классы в которых используются методы 
> печати - тем самым я бы избежал создание экземпляра класса и все методы ввыода хранил бы в интерфейсе, 
> и аналогично бы сделал для всх методов работы над древом, и хранил бы их в интерфейсах 
> 
