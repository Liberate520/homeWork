...
//         oldOthers others1 = new oldOthers(1, "иван", "инженер");
//         oldOthers others2 = new oldOthers(2, "петр", "программист");
        
//         List<oldOthers> otherList = new ArrayList<>(Arrays.asList(others1, others2));

//         for (oldOthers value : otherList)  
//         {
