...
// не знаю уже зачем столько наделал, но удалять жалко
    ...
    public Person(String firstName, String lastName, LocalDate dateOfBirth, LocalDate dateOfDeath, Sex sex) {
        id = setId();
        if (firstName == null && sex == Sex.MALE) this.firstName = "John";
        else if (firstName == null && sex == Sex.FEMALE) this.firstName = "Jane";
...
// Getters and Setters
    ...
    private int setId() {
        //TODO: реализовать хранение максимального id в отдельном файле или в качестве ключа map к FamilyTree
        incrementalID++;
