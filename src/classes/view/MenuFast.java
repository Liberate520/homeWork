...
//                System.out.println("Пока обычное меню (настраиваемое пока не запустилось (из MAIN)");
            System.out.println("   МЕНЮ >>>> Введите код операции: (Пока обычное меню (настраиваемое пока не запустилось (из MAIN)");
