...
public class Communications {
    ...
    public Communications(Human person1, Human person2, Relations relation) {
    ...
    public String toString() {
        return String.format("%s  =>  %s для %s ", getPeople().getName(),
         getRelationType(),getRelationPeople().getName()
                        );
    }
}
