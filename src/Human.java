...
public class Human {
    ...
    public Human(String name, String surname, String manOrWoman, String birthday){
...
//        this.dateOfDeath = "Жив";
    ...
    public Human(String name, String surname, String manOrWoman, String birthday, String dateOfDeath) {
        this.name = name;
