...
public class TreeConsrtructor extends Person {
    ...
    public Person restorePersonByInfo(String personInfo) {
        ...
        // String personInfo = "4, имя: Мишина Олеся, дата рождения: 1979-09-14,
        // возраст: 43, пол: female, мать: Мишина Надежда, отец: Мишин Анатолий, дети:
        // Вяткин Константин Вяткин Кирилл,";
