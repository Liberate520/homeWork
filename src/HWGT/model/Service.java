...
public class Service implements FileData {
    ...
    public boolean checkName (String name){return (familyTree.getPerson(name)!=null);}
    ...
    public String addPerson (String personName, String personSex, Integer birthData, Integer deathData){
        ...
        return comment = "Человек добавлен";
    ...
    public String searchPerson(String nameForSearch){return familyTree.getPerson(nameForSearch).toString();}


    public void sortByName() {familyTree.sortByName();}

    public void sortByBirthDate() {familyTree.sortByBirth();}
