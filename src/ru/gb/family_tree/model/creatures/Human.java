...
public class Human implements Serializable, Creature<Human> {
    ...
    public boolean setMother(Human mother) {
        if (this.mother != null) {
            System.out.println("Mother was set yet");
            return false;
        } else {
            this.mother = mother;
            return true;
    ...
    public boolean setFather(Human father) {
        if (this.father != null) {
            System.out.println("Father was set yet");
            return false;
        } else {
            this.father = father;
            return true;
        ...
        if (this.children != null) {
            for (Human child1 : children) {
                if (child1.equals(child)) {
                    System.out.println("This child was set yet");
                    return;
                }
            }
        }
    ...
    public String toString() {
        ...
        sb.append(String.format("Name, Surname: %s %s%n", this.firstName, this.lastName));
        ...
        if (this.deathDate != null) {
            ...
            sb.append(String.format("Birthday: %s%n", this.birthDate));
            sb.append("Deathday:" + this.deathDate + "\n");
        ...
        if (this.mother != null) {
            sb.append(String.format("Mother: %s%n", this.mother.getName()));
        }
        if (this.father != null) {
            sb.append(String.format("Father: %s%n", this.father.getName()));
        }
        if (this.spouse != null) {
            sb.append(String.format("Spouse: %s%n", this.spouse.getName()));
        }
        if (this.children != null) {
            sb.append("Children: ");
