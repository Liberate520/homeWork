...
public class Main {
    ...
    private static void addNodes(FamilyTree treeName, PersonSaver personName){
        ...
        System.out.println(treeName.getObjectById(11) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(21) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(22) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(31) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(32) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(33) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(34) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(41) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(42) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(43) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(44) + "\n");
        tempNode.clear();
        ...
        treeName.addNode(tempNode);
        System.out.println(treeName.getObjectById(52) + "\n");
        tempNode.clear();
    }
    ...
    private static void addPersons(PersonSaver personName){
        ...
        System.out.println(personName.getObjectById(11));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(12));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(21));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(22));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(23));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(31));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(34));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(35));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(36));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(37));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(38));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(43));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(44));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(49));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(53));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(54));
        tempPerson.clear();
        ...
        personName.addPerson(tempPerson);
        System.out.println(personName.getObjectById(55));
        tempPerson.clear();
    }
}
