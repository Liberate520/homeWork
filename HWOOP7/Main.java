...
public class Main {
    ...
    public static void main(String[] args) {
        FamilyTree<Human> treeRelations = new FamilyTree<>();
        FamilyTree<Human> treeFamily = new FamilyTree<>();
        ...
        treeFamily.sortByFirstName();
        System.out.println("Family Tree sorted by FirstName:\n" + treeFamily.print());
        treeFamily.sortByAge();
